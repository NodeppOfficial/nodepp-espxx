...
public:
    ...
    tls_t( ssl_t* crt=nullptr, agent_t* opt=nullptr ) noexcept : obj( new NODE() )
...
namespace tls {
    ...
    inline tls_t server( ssl_t* ssl=nullptr, agent_t* opt=nullptr ){ auto skt = tls_t( ssl, opt ); return skt; }

    inline tls_t client( ssl_t* ssl=nullptr, agent_t* opt=nullptr ){ auto skt = tls_t( ssl, opt ); return skt; }
